...
class AutobuildTool(autobuild_base.AutobuildBase):
    ...
    def register(self, parser):
        parser.description = (
            "uninstall artifacts installed by the 'autobuild install' command."
        )
        parser.add_argument("package", nargs="*", help="List of packages to uninstall.")
        ...
        if os.path.isabs(installed_filename):
            ...
            for build_configuration in build_configurations:
                ...
                installed_filenames = [
                    ...
                    for install_dir in common.select_directories(
                        args,
                        config,
                        "install",
                        "uninstalling",
                        lambda cnf: os.path.join(build_directory, "packages"),
                    )
                ]
